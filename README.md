...
### Introduction
This repository is a [ALX Software Engineering Course](https://www.alxafrica.com/) Project. The school project consisted in writing a shell like sh (Bourne Shell) by Stephen Bourne  , in **C**, using a limited number of standard library functions, So Instead we used ower own function that we rewrited over the past three month [Here](https://github.com/Johnjai99/alx-low_level_programming/), also [Here](https://github.com/Magna1/alx-low_level_programming)
...
## Authors
* Ogunronbi John [Johnjai99](https://github.com/Johnjai99)
* Iheka Olivia [magna1](https://github.com/Magna1)
